...
When starting up the application, you will be able to see the *Home Screen* below.
...
[WARNING]
This symbol and corresponding box has warnings which you might want to be aware of.
====
...
When managing lessons, you will be able to see the *Lesson View Screen* below.
