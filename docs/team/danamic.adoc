...
* *Major enhancement*: Implemented Major and Major Set Command, for Users who wish to change their Student's Major retroactively
** What it does: This feature allows students to change their Major, with CS and IS Majors currently supported
** Justification:
** Highlights:
** Credits:

* *Major enhancement*: Worked with @Capeguy to ensure Modules Loaded from JSON files contained the right information to be used for the application
** What it does:
** Justification:
** Highlights:
** Credits:
...
** Credits: The original code from AddressBook-Level3, @Capeguy, @gruntultra

* *Minor enhancement*: added and modified a significant amount of the Test Cases and Unit Tests for the NUS Module Planner.
* *Minor enhancement*: created helper classes to faciliate easier testing of models such as TypicalModule and ModuleBuilder
