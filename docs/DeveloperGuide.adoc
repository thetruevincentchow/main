...
==== Graduation Models
image::ModelPackageGraduation.png[]
...
. Matching of the sub `Graduation Requirements` (which can come in the form of _"Specialisations" or "Tracks"_ depending on the terminology of the respective faculty that the `Major` belongs to), of the `Specialisation` given and compiled.
