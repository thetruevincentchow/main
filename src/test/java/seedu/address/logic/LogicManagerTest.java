...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        StorageManager storage = new StorageManager(addressBookStorage, userPrefsStorage, plannerStorage); // TODO fix planner storage
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        StorageManager storage = new StorageManager(addressBookStorage, userPrefsStorage, jsonPlannerStorage); // TODO
        logic = new LogicManager(model, storage);
